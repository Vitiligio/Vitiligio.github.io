...
impl SuperTateti {
    ...
    pub fn new() -> SuperTateti {
        ...
        SuperTateti {
            ...
            map: vec![vec![Tateti::new(), Tateti::new(), Tateti::new()], vec![Tateti::new(), Tateti::new(), Tateti::new()], vec![Tateti::new(), Tateti::new(), Tateti::new()]],
...
impl Tateti {
    ...
    let mut transposed = vec![vec![' ', ' ', ' '], vec![' ', ' ', ' '], vec![' ', ' ', ' ']];
